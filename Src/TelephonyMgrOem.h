...
*
* Description:
*		This is the header file for the Telephony Manager Extension for Palm OS 
*		Wireless Telephony Add-on.
*		It defines the new Telephony Manager public functions.
*
* History:
*		11/21/00	Thierry Langlais	Initial version.
*		07/18/01	Hatem Oueslati		GPRS API Update.
*		08/16/01	Thierry Langlais	Added Palm GSM specific errors.
* 		09/12/01	Christophe Guiraud	Added USSD API
*		10/05/01	Christophe Guiraud	Added Alert API
*		10/09/01	Hatem Oueslati		Voice Recognition API update
*		10/15/01	Thierry Langlais	I Added TelOemCfgSetPhoneRTC() and
*										TelOemCfgGetPhoneRTC() APIs.
*		01/08/02	Hatem Oueslati		Added 
*										TelOemSmsIsMessageGsmAlphabetCompatible 
*										API
*		01/25/02	Thierry Langlais	Reorganised new functions added before
